...
In Termux on Android, generating `src/parser.c` for [tree-sitter-latex](https://github.com/latex-lsp/tree-sitter-latex) can require more memory than is available to the process. This can cause parser installation to fail with an error such as:
```
